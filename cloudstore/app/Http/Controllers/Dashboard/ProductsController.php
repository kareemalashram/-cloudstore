...
class ProductsController extends Controller
{
    ...
    public function saveProductPrice(ProductPriceRequest $request){
        ...
        try{
            ...
            Product::whereId($request -> product_id) -> update($request -> only(['price','special_price','special_price_start','special_price_type','special_price_start','special_price_end']));
